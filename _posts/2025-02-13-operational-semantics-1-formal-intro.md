...
Unlike informal explanations that might say "this expression evaluates to that value," operational semantics provides explicit rules governing exactly _how_ expressions transform into values through a series of state transitions.
